...
*/
        //------- CÓDIGO PARA AÑADIR PRODUCTOS A LA BASE DE DATOS -------
        ...
        Category category1 = new Category("Frutas, verduras, tubérculos", "vegetablesfruits.jpg");
        ...
        Category category2 = new Category("Bebidas vegetales", "vegetablesdrinks.jpg");
        ...
        Category category3 = new Category("Lácteos", "milks.jpg");
        ...
        Category category4 = new Category("Productos de limpieza", "cleaning.jpg");
        ...
        */
        ...
        //------- CÓDIGO PARA AÑADIR CATEGORÍAS A LA BASE DE DATOS Y SE CREE UN ARRAY DE PRODUCTOS COMO COLLECTION -------

        /*
        db.collection("categories").add(category1)
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    @Override
                    public void onSuccess(DocumentReference documentReference) {
                        for (Product product : productsInCategory1) {
                            documentReference.collection("products").add(product);
                        }
                        Log.d(MainActivity.class.getSimpleName(), "Document added with ID: " + documentReference.getId());
                    }
                }).addOnFailureListener(new OnFailureListener() {
